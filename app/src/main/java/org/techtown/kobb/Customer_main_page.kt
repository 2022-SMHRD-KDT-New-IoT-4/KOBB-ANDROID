...
class Customer_main_page : AppCompatActivity() {
    ...
    //먹고가기 선택시 실행 되는 함수
    fun handleEatClick() {
        val voice_text: String = "먹고가기를 선택하셨습니다, 음료 종류를 선택하세요, 커피는 1번 라떼는 2번 에이드는 3번 요거트는 4번"
    ...
    //포장하기 선택시 실행 되는 함수
    fun handleTakeOut(){
        val voice_text: String = "포장하기를 선택하셨습니다, 음료 종류를 선택하세요, 커피는 1번 라떼는 2번 에이드는 3번 요거트는 4번"
        Log.d("TAG", "onCreate: 음성출력")
        ttsSpeak(voice_text)
